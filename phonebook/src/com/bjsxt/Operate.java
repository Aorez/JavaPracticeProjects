...
public class Operate {
    private List<com.bjsxt.Person> list ;
    public Operate(){
    ...
    public void addOperation(){
        ...
        com.bjsxt.Person person = new com.bjsxt.Person(name,age,sex,telNum,address);
     ...
     * 按姓名排序的比较器
     */
    class OrderByName implements Comparator<com.bjsxt.Person>{
        @Override
        public int compare(com.bjsxt.Person o1, com.bjsxt.Person o2) {
     ...
     * 按年龄排序的比较器
     */
    class OrderByAge implements Comparator<com.bjsxt.Person>{
        @Override
        public int compare(com.bjsxt.Person o1, com.bjsxt.Person o2) {
     ...
     * 按性别排序的比较器
     */
    class OrderBySex implements Comparator<com.bjsxt.Person>{
        @Override
        public int compare(com.bjsxt.Person o1, com.bjsxt.Person o2) {
